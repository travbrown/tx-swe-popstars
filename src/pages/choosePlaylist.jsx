            ...
            <div className="centerItems">
                <header className ="App-header">
                    ...
                    <Card.Img variant="top" src= {album_one} />
                        <center> 
                        <Card.Footer> <Link to="/playlistOne" class ="card_button"> Friday Hits </Link> </Card.Footer>
                        </center>
                    </Card>
                    ...
                    <center> 
                    <Card.Footer> <Link to="/playlistTwo" class ="card_button"> TechX Jam </Link> </Card.Footer>
                        </center>
                    </Card>
                    ...
                    <Card.Img variant="top" src= {album_one} />
                    <center> 
                        <Card.Footer> <Link to="/playlistThree" class ="card_button"> happy songs </Link> </Card.Footer>
                    </center>
                    </Card>
                    </CardDeck>
                </header>
